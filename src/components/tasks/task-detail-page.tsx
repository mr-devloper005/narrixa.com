...
export async function TaskDetailPage({ task, slug }: { task: TaskKey; slug: string }) {
  ...
  if (productKind === "directory" && (task === "listing" || task === "classified" || task === "profile")) {
    return (
      <div className="min-h-screen bg-[#FBDB93]/20">
        <NavbarShell />
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        >
          <div className={cn(isClassified ? "space-y-8" : "")}>
            {isArticle ? (
              <div className="mx-auto w-full max-w-4xl space-y-6">
                ...
                {images[0] ? (
                  <div className="relative aspect-[16/9] w-full overflow-hidden rounded-3xl border border-[#BE5B50]/20 bg-[#FBDB93]/20">
                    <ContentImage
                      src={images[0]}
            ...
            {isClassified ? (
              <div className="mx-auto w-full max-w-4xl rounded-2xl border border-[#BE5B50]/20 bg-white p-6">
            ...
            {content.highlights?.length && !isArticle ? (
              <div className={cn("mt-8 rounded-2xl border border-[#BE5B50]/20 bg-white p-6", isClassified ? "mx-auto w-full max-w-4xl" : "")}>
            ...
            {isClassified && mapEmbedUrl ? (
              <div className="mx-auto w-full max-w-4xl rounded-2xl border border-[#BE5B50]/20 bg-white p-4">
          ...
          {!hideSidebar ? (
            ...
            <div className="rounded-2xl border border-[#BE5B50]/20 bg-white p-6">
            ...
            {mapEmbedUrl ? (
              <div className="rounded-2xl border border-[#BE5B50]/20 bg-white p-4">
                <p className="text-sm font-semibold text-foreground">Location map</p>
                <div className="mt-4 overflow-hidden rounded-xl border border-border">
                  <iframe
                    title="Business location map"
        ...
        <section className="mt-12">
          ...
          <nav className="mt-6 rounded-2xl border border-[#BE5B50]/20 bg-white/60 p-4">
